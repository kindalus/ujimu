...
| 77 | [`77-staged-derived-repair.html`](./77-staged-derived-repair.html) | `idea-refined` | — | Scope refined: repair each quarantined page in an isolated copy, admit only new evidence pages, and promote after favourable post-check. |
