...
| 76 | [`76-derived-alignment-attribution-quarantine.html`](./76-derived-alignment-attribution-quarantine.html) | `idea-refined` | — | Scope refined: validated five-level judgement, separate negative attribution, and code-enforced quarantine without wiki writes. |
