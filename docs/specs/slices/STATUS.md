...
| 60 | [`60-control-language-profile-polish.html`](./60-control-language-profile-polish.html) | `idea-refined` | — | Final CSS cascade owns action pills, circular icons, underlined input/textarea fields, link actions, and profile spacing. |
