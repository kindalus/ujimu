...
| 75 | [`75-derived-verification-sampling-baseline.html`](./75-derived-verification-sampling-baseline.html) | `planned` | — | Persist sampled derived-answer checks and generate an independent default-model baseline with derived pages blocked in code. |
