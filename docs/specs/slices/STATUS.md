...
| 60 | [`60-control-language-profile-polish.html`](./60-control-language-profile-polish.html) | `grilled` | — | Locked enabled-pointer semantics, 2px underline focus, link-button exemption, circular variants, and explicit composer/OTP/select/card exclusions. |
